...
(def ^:large-vars/data-var dicts
  {:en {:tutorial/text #?(:cljs (rc/inline "tutorial-en.md")
   ...
   :zh-Hant {:on-boarding/demo-graph "This is a demo graph, changes will not be saved until you open a local folder."
             ...
             :help/block-content-autocomplete "區塊內容 (Src, Quote, Query 等) 自動完成"
             :help/reference-autocomplete "頁面引用自動補齊"
             ...
             :file/no-data "沒有數據"
             :file/format-not-supported "格式 .{1} 目前不支持."
             :editor/block-search "搜索區塊"
             :editor/image-uploading "正在上傳"
             :draw/invalid-file "無法讀取無效的 excalidraw 文件"
             :draw/specify-title "請先指定標題!"
             :draw/rename-success "文件重新命名成功!"
             :draw/rename-failure "文件重新命名失敗，原因是："
             :draw/title-placeholder "未命名"
             :draw/save "儲存"
             :draw/save-changes "儲存更改"
             :draw/new-file "新文件"
             :draw/list-files "所有文件"
             :draw/delete "刪除"
             ...
             :content/copy-block-ref "複製區塊引用"
             :content/focus-on-block "聚焦在此區塊"
             :content/open-in-sidebar "在側邊欄打開"
             :content/copy-as-json "複製為 JSON"
             ...
             :settings-page/git-switcher-label "Enable Git auto commit"
             :settings-page/git-commit-delay "Git auto commit seconds"
             :settings-page/preferred-file-format "文件格式偏好"
             :settings-page/preferred-workflow "工作流偏好"
             ...
             :settings-page/developer-mode-desc "開發者模式幫助貢獻者和套件開發者更有效地測試他們與 Logseq 的整合。"
             :settings-page/tab-general "常規"
             :settings-page/tab-editor "編輯器"
             :settings-page/tab-shortcuts "快速鍵"
             :settings-page/tab-advanced "進階設置"
             :logseq "Logseq"
             :on "已打開"
             :more-options "更多選項"
             :to "至"
             ...
             :export-markdown "以 Markdown 格式匯出"
             :export-opml "以 OPML 格式匯出"
             :convert-markdown "轉換為 Markdown 格式(Unordered list 或 Heading)"
             :unlink "解除綁定"
             :search/publishing "尋找"
             :search "尋找或是創建新頁面"
             :new-page "新頁面"
             :graph "圖譜"
             ...
             :help-shortcut-title "點此查看快捷鍵及其他幫助"
             :loading "讀取中"
             :cloning "正在複製"
             :parsing-files "正在解析文件"
             :loading-files "正在讀取文件"
             :go-to "轉到"
             :or "或"
             :download "下載"
             :language "語言"
